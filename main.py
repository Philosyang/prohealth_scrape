...
for i in range(1, page_count+1):
    ...
    for item in clist:
        ...
        # $58.00    </span>
        item_price = float(ipt[ipt.index('$') + len('$')
                           :ipt.index('</span>')].strip().replace(',', ''))
